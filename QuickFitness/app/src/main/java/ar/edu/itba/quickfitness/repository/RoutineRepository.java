...
public class RoutineRepository {
    ...
    private Routine mapRoutineDomainToModel(RoutineDomain domain) {
        ...
        model.setAverageRating(domain.getAverageRating());
        model.setIsPublic(domain.getIsPublic());
        model.setDifficulty(domain.getDifficulty());
        model.setCreator(domain.getCreator());
